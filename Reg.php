...
{  
...

	{
        document.fm.cpass.style.color="black";
	     	document.getElementById("con").innerHTML="Password have matched.";
...
?>
   ...
   <a href="index.php" title=""  style="width: 97%;background-color: #4CAF50;color: white;padding: 14px 20px;margin: 8px 0;border: none;
